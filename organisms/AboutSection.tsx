...
const AboutSection = ({ about = "" }) => {
  return (
    <div className="second-bg" id="about">
      <div className="pl-[33.1875rem] pt-[16.75rem] dark:bg-[#1F2937E5] sm:bg-none dark:bg-none">
        <div>
          <p className="dark:text-white">ABOUT ME</p>
          <p className="font-bold text-[2.5rem] text-[#1f2037] dark:text-white">
            A bit about me.
          </p>
          <p className="text-[#4f4f4f] font-semibold max-w-[40rem] sm:text-sm  text-lg pt-6 dark:text-white">
            {about
              ? about
